    ...
    <div className=" min-h-screen flex flex-col lg:flex-row items-center md:mx-32 mx-5 gap-14">
      <div className=" w-full lg:w-2/4">
        <div className=" space-y-4 pr-10">
          ...
          <p>
            Discover Amazing Places with Travel Agency! We carefully choose the
            best destinations around the world, making sure you always have an
      ...
      <div className=" w-full lg:w-2/4 space-y-10">
        ...
        <div className=" flex flex-row gap-5">
          ...
          <div className=" space-y-3">
            <h1 className=" font-semibold text-xl">Continuous Support</h1>
            <p className=" text-[#898888]">
              We will provide excellent continuous support for the sake of our
              customers.
            </p>
          </div>
        </div>
